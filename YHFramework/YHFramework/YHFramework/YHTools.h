...
#pragma mark - Handler for Image Cache
...
- (CGFloat)getStringWidthWithString:(NSString *)str maxWidth:(CGFloat)maxWidth maxLine:(NSInteger)maxLine font:(UIFont *)fontType; // Width for label line
