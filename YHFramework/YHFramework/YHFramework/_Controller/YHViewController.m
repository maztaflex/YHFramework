...
{
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handlerForNotificationCenter:) name:YHShouldAllRefreshNotification object:nil];
}
...
- (void)handlerForNotificationCenter:(NSNotification *)notification
{
    ...
    if ([notifyName isEqualToString:YHShouldAllRefreshNotification])
    {
        [self refreshAllUI];
    }
    
    if ([notifyName isEqualToString:YHShouldAllWebViewRefreshNotification])
    {
...
{
    [self showAlertViewWithMessage:phoneNumber confirmButtonTitle:@"OK" cancelButtonTitle:@"Cancel" confirmCompletion:^{
        [self.tools callWithPhoneNumber:phoneNumber];
    }];
}
...
- (void)didReceiveMemoryWarning {
    ...
    LogRed(@"didReceiveMemoryWarning");
}
